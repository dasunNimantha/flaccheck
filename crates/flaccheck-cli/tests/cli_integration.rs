...
use flaccheck_core::{AnalysisConfig, ScanMode, TranscodeVerdict};
use flaccheck_ml::{MlClassifier, MlConfig};
use flaccheck_testkit::{full_corpus, write_wav_f32_mono};
use std::process::Command;

fn flaccheck_bin() -> Command {
    Command::new(env!("CARGO_BIN_EXE_flaccheck"))
}
...
fn decode_roundtrip_matches_direct_analyze() {
    use flaccheck_decode::decode_file;
