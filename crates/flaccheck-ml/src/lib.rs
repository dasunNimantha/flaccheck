...
use flaccheck_core::{AnalysisResult, Evidence, PcmBuffer, TranscodeVerdict};
use thiserror::Error;
...
mod tests {
    ...
    fn classical_refine_borderline_adds_evidence() {
        use flaccheck_core::{AnalysisResult, HiresVerdict, ScanMode, TranscodeVerdict};
        ...
        let mut result = AnalysisResult {
            ...
            confidence: 0.5,
            evidence: vec![
                flaccheck_core::Evidence::new("spectral", "brick_wall", 0.9, 1.0, ""),
                flaccheck_core::Evidence::new("spectral", "spectral_info_score", 0.5, 0.0, ""),
            ],
            codec_guess: None,
